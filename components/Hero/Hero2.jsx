          ...
          <h1 className="text-[27px] sm:text-[48px] md:text-5xl xl:text-6xl firaCode relative text-gray-800 dark:text-slate-100">
            ...
            <div className="absolute bottom-0 z-10 hidden md:flex">
              <Highlighter
                theme={theme}
                type="yellow"
                props={{ viewBox: '0 0 219 66', height: '48px' }}
              />
            </div>
            <div className="absolute bottom-2 z-10 md:hidden flex">
              <Highlighter
                theme={theme}
                type="yellow"
                props={{ viewBox: '0 0 202 58', height: '21px' }}
              />
            </div>
          ...
          <h1 className="text-[27px] sm:text-[48px] md:text-5xl xl:text-6xl firaCode relative text-gray-800 dark:text-white">
            ...
            <div className="absolute bottom-0 z-10 hidden md:flex">
              <Highlighter
                theme={theme}
                type="red"
                props={{ viewBox: '0 0 202 58', height: '48px' }}
              />
            </div>
            <div className="absolute bottom-2 z-10 md:hidden flex">
              <Highlighter
            ...
            <span className="ml-2 md:ml-4">by night.</span>
          </h1>
          <h1 className="text-[27px] sm:text-[48px] flex whitespace-nowrap md:flex-nowrap md:text-5xl xl:text-6xl firaCode text-gray-800 dark:text-white">
            <span className=" mr-2 md:mr-4">And a Full-time</span>
            <div className="relative">
              <span className="z-20 relative">Overthinker</span>
              <div className="absolute hidden md:flex bottom-0 z-10">
                <Highlighter
                  theme={theme}
                  type="blue"
                  props={{ viewBox: '0 0 421 70', height: '58px' }}
                />
              </div>
              <div className="absolute  md:hidden flex bottom-0 z-10">
                <Highlighter
                  theme={theme}
                  type="blue"
                  props={{ viewBox: '0 0 421 70', height: '38px' }}
                />
              </div>
            </div>
          </h1>
        ...
        <div className="mt-[-40px] md:mt-[-5rem] col-span-2 md:min-h-[25rem] flex items-center">
          <div className="w-full  flex flex-col ">
            ...
            <p className="text-2xl text-gray-800 dark:text-white font-semibold caveat max-w-[20rem] mb-4">
              With more than {exp} Years of experience {about.description[0]}
            </p>
